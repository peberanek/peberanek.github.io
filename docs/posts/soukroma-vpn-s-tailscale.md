...
_Update:_ "check mode" pro Tailscale SSH je skutečně zapnutý by default, třebaže dokumentace říká, že je optional. Autentizovat se po 12 hodinách, zvlášť potom co jsem začal server využívat i pro hosting gitovských repozitářů, začalo být otravné. Check mode se dá vypnout v [Access Control administrátorské konzoli](https://tailscale.com/docs/features/tailscale-ssh#ensure-tailscale-ssh-is-permitted-in-access-control-policies) > Tailscale SSH > ... > Edit.
