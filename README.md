...
Jinými slovy, zkušeného schopného programátora GenAI nástroje mohou ještě více posílit, naopak člověka bez zkušeností mohou zavést do slepé uličky, protože nebude schopen vidět problémy jako vadný design nebo bezpečnostní zranitelnosti. _Augmentation, not a replacement._

Zajímavá historická paralela: ['computer'](https://en.wikipedia.org/wiki/Computer_(occupation)) byl svého času název profese vykonávané lidmi. Dneska už jej jen těžko bereme jako něco jiného než stroj, automat. Nebudu překvapen, pokud jednoho dne bude 'programmer' také jen inteligentní stroj, a člověk "jen" software architekt, nebo jednoduše _App Maker_.
