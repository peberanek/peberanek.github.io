...
Exploring the world of generative AI at [Charles University](https://cuni.cz/UKEN-1.html). Formerly a Software Quality Engineer at [Red Hat](https://www.redhat.com/).
...
* Ness, _Junior Software Quality Engineer_ (3/2018 - 10/2018)
...
* Khan Academy, _Math_ (online, 2016)
...
* English (C1), Czech (native speaker)
* automation with Python and shell, Linux (Ubuntu, RHEL/Fedora), git & GitHub
* playing with ChatGPT, Claude and GitHub Copilot
* minor experience with JavaScript, SQL, Rust, C, Perl, Linux containers and RPM packaging

## Hobbies & Activities

* long walks and trips on kickbike, traveling
* reading
* practicing Mindfulness-based stress reduction and the Tiny Habits method
